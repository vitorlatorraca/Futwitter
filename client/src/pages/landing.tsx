    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#0f0f0f] to-[#1a1a1a] text-white">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-24 lg:py-32">
        <div className="text-center mb-12 sm:mb-16 md:mb-20">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm mb-6 sm:mb-8">
            <Zap className="h-3 w-3 sm:h-4 sm:w-4 text-[var(--theme-primary)]" />
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <Link href="/cadastro" data-testid="link-signup">
              <Button 
                size="lg" 
                className="w-full sm:w-auto text-sm sm:text-base font-medium px-6 sm:px-8 py-5 sm:py-6 h-auto bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-neon)] hover:from-[var(--theme-primary)] hover:to-[var(--theme-neon)] text-white rounded-lg shadow-lg shadow-[var(--theme-primary)]/20 transition-all duration-300"
              >
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="mb-8 sm:mb-10 md:mb-12">
          ...
          <div className="w-16 sm:w-20 md:w-24 h-px bg-gradient-to-r from-transparent via-[var(--theme-primary)] to-transparent mx-auto"></div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 border border-white/10 shadow-2xl">
            {/* Gradient overlay */}
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--theme-primary)]/10 via-transparent to-[var(--theme-neon)]/10 rounded-3xl pointer-events-none"></div>
            
            <div className="relative z-10">
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-0.5 sm:w-1 h-6 sm:h-8 bg-gradient-to-b from-[var(--theme-primary)] to-[var(--theme-neon)] rounded-full"></div>
              ...
              <div className="space-y-4 sm:space-y-5 md:space-y-6 text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed font-light">
                ...
                <p className="text-gray-300/90">
                  Começamos com uma arquitetura full-stack moderna: <span className="text-[var(--theme-primary)]">React 18 + TypeScript</span> no frontend, 
                  <span className="text-[var(--theme-primary)]"> Express.js</span> no backend, e <span className="text-[var(--theme-primary)]">PostgreSQL</span> como banco de dados. 
                  A escolha do <span className="text-[var(--theme-primary)]">Drizzle ORM</span> garantiu type-safety em todo o 
          ...
          {/* Decorative elements */}
          <div className="absolute -top-4 -right-4 w-32 h-32 bg-[var(--theme-primary)]/20 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-4 -left-4 w-40 h-40 bg-[var(--theme-neon)]/20 rounded-full blur-3xl"></div>
        </div>
      </section>
